            ...
            <div className="">
                ...
                mt-4 rounded-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="flex  flex-col gap-3 mx-auto mt-5 w-full text-gray-900" method="get">
                            ...
                            <span className="self-center"><span>Already have an account? </span><Link href={"/login"} className="text-primary-green hover:underline dark:text-cyan-500 font-medium">Log In</Link></span>
